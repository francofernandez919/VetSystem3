...
{
    public partial class Form_Turnos_Registrar1 : Form
    {
        private SqlDataAdapter adaptador;
        private SqlConnection conexion;

        public Form_Turnos_Registrar1()
        {
            InitializeComponent();
        }
        ...
        private void Form_Turnos_Registrar1_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form_Turnos_Registrar2 registrarTurnos2 = new Form_Turnos_Registrar2();
                registrarTurnos2.labelDNI.Text = textBoxDNI.Text;
                registrarTurnos2.Show();
            }
        }
    }
}
